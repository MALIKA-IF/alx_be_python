...
match priority:
    case "high":
         if time_bound =="yes":
           ...
           print(f"Note:{task}you have task Now,Consider completing it when you have free time")
    ...
    case "low" :
        if time_bound =="yes":
             ...
             print(f"Note:{task}you have an important task Now,Consider completing it when you have free time")
    case _:
